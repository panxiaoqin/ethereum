...
public class Transaction {
    ...
    public static Integer extractChainIdFromV(BigInteger bv) {
        if (bv.bitLength() > 31)
...
//        if (!isEmpty(hash)) return hash;
    ...
    public void sign(ECDSASignature key) throws MissingPrivateKeyException {
        this.rlpRaw = null;
        this.getRawHash();
        this.signature = key;
        this.rlpEncoded = null;
    ...
    public void setSignature(byte[] data) throws MissingPrivateKeyException {
        this.getRawHash();
        BigInteger v = BigInteger.valueOf(data[0]);
        this.chainId = Transaction.extractChainIdFromV(v);
        data[0] = Transaction.getRealV(v);
        this.signature = ECDSASignature.fromComponents(data);
        this.rlpEncoded = null;
    }
    ...
    public byte[] getEncoded() {
        ...
        if (signature != null) {
            ...
            String r1 = signature.r.toString(16);
            String s1 = signature.s.toString(16);
