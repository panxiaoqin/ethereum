...
public class ECKey implements Serializable {
    ...
    public static class ECDSASignature {
        ...
        public static ECDSASignature fromComponents(byte[] data) {
            return fromComponents(Arrays.copyOfRange(data, 1, 33), Arrays.copyOfRange(data, 33, 65), data[0]);
        }
        ...
        public String toBase64() {
            ...
            sigData[0] = v;
            System.out.println(Hex.toHexString(bigIntegerToBytes(this.r, 32)));
            System.out.println(Hex.toHexString(bigIntegerToBytes(this.s, 32)));
